...
STRINGS: dict[str, str] = {
    ...
    # ── PQ e-mail (issue #443) ────────────────────────────────────────────────
    "settings_tab_email":                  "E-mail PQ",
    "email_intro":                         "Ligue uma conta de e-mail para obter automaticamente os ficheiros zip de Pocket Query enviados pelo Geocaching.com, em vez de os transferir manualmente.",
    "email_group_connection":              "Ligação",
    "email_server_label":                  "Servidor IMAP:",
    "email_port_label":                    "Porta:",
    "email_username_label":                "Endereço de e-mail:",
    "email_password_label":                "Palavra-passe:",
    "email_password_placeholder_saved":    "•••••••• (guardada — deixe em branco para manter)",
    "email_password_placeholder_new":      "Introduza a palavra-passe",
    "email_help_app_password":             "O Gmail, iCloud e a maioria dos outros fornecedores exigem aqui uma palavra-passe específica da aplicação, não a sua palavra-passe normal da conta — verifique as definições de segurança da sua conta para gerar uma.",
    "email_help_no_outlook":               "Outlook.com/Live.com ainda não é suportado aqui — a Microsoft exige um método de login diferente para essas contas (tratado separadamente).",
    "email_test_btn":                      "Testar ligação",
    "email_status_untested":               "Ainda não testado",
    "email_status_testing":                "A testar...",
    "email_status_success":                "Ligação bem-sucedida",
    "email_status_auth_error":             "Falha no login — verifique o endereço de e-mail e a palavra-passe",
    "email_status_network_error":          "Não foi possível contactar o servidor — verifique o endereço e a porta",
    "email_status_unknown_error":          "Ocorreu um erro — consulte os registos para mais detalhes",
    "email_status_missing_fields":         "Preencha primeiro o servidor, o endereço de e-mail e a palavra-passe",
    "email_save_error_title":              "Não foi possível guardar a palavra-passe",
    "email_save_error_msg":                "Não foi possível guardar a palavra-passe no armazenamento seguro de credenciais do sistema. As definições de ligação foram guardadas, mas pode ser necessário introduzir a palavra-passe novamente da próxima vez.",
