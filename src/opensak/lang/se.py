...
STRINGS: dict[str, str] = {
    ...
    # ── PQ e-mail (issue #443) ────────────────────────────────────────────────
    "settings_tab_email":                  "PQ e-post",
    "email_intro":                         "Anslut ett e-postkonto för att automatiskt hämta Pocket Query-zipfiler som Geocaching.com skickar till dig, istället för att ladda ner dem manuellt.",
    "email_group_connection":              "Anslutning",
    "email_server_label":                  "IMAP-server:",
    "email_port_label":                    "Port:",
    "email_username_label":                "E-postadress:",
    "email_password_label":                "Lösenord:",
    "email_password_placeholder_saved":    "•••••••• (sparat — lämna tomt för att behålla)",
    "email_password_placeholder_new":      "Ange lösenord",
    "email_help_app_password":             "Gmail, iCloud och de flesta andra leverantörer kräver ett appspecifikt lösenord här, inte ditt vanliga kontolösenord — kontrollera kontots säkerhetsinställningar för att skapa ett.",
    "email_help_no_outlook":               "Outlook.com/Live.com stöds inte här än — Microsoft kräver en annan inloggningsmetod för dessa konton (hanteras separat).",
    "email_test_btn":                      "Testa anslutning",
    "email_status_untested":               "Inte testat än",
    "email_status_testing":                "Testar...",
    "email_status_success":                "Anslutningen lyckades",
    "email_status_auth_error":             "Inloggning misslyckades — kontrollera e-postadress och lösenord",
    "email_status_network_error":          "Kunde inte nå servern — kontrollera serveradress och port",
    "email_status_unknown_error":          "Något gick fel — se loggar för detaljer",
    "email_status_missing_fields":         "Fyll i server, e-postadress och lösenord först",
    "email_save_error_title":              "Kunde inte spara lösenord",
    "email_save_error_msg":                "Lösenordet kunde inte sparas i systemets säkra inloggningslager. Anslutningsinställningarna sparades, men du kan behöva ange lösenordet igen nästa gång.",
