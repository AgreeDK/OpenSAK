...
STRINGS: dict[str, str] = {
    ...
    "email_intro":                         "Forbind en e-mail-konto for automatisk at hente Pocket Query zip-filer, som Geocaching.com sender til dig, i stedet for at downloade dem manuelt.",
    "email_group_connection":              "Forbindelse",
    "email_server_label":                  "IMAP-server:",
    "email_port_label":                    "Port:",
    "email_username_label":                "E-mailadresse:",
    "email_password_label":                "Adgangskode:",
    "email_password_placeholder_saved":    "•••••••• (gemt — lad stå tom for at beholde)",
    "email_password_placeholder_new":      "Indtast adgangskode",
    "email_help_app_password":             "Gmail, iCloud og de fleste andre udbydere kræver et app-specifikt password her, ikke din normale kontoadgangskode — tjek din kontos sikkerhedsindstillinger for at generere et.",
    "email_help_no_outlook":               "Outlook.com/Live.com understøttes ikke her endnu — Microsoft kræver en anden logmetode til de konti (håndteres separat).",
    "email_test_btn":                      "Test forbindelse",
    "email_status_untested":               "Ikke testet endnu",
    "email_status_testing":                "Tester...",
    "email_status_success":                "Forbindelse lykkedes",
    "email_status_auth_error":             "Login mislykkedes — tjek e-mailadresse og adgangskode",
    "email_status_network_error":          "Kunne ikke nå serveren — tjek serveradresse og port",
    "email_status_unknown_error":          "Noget gik galt — se logs for detaljer",
    "email_status_missing_fields":         "Udfyld server, e-mailadresse og adgangskode først",
    "email_save_error_title":              "Kunne ikke gemme adgangskode",
    "email_save_error_msg":                "Adgangskoden kunne ikke gemmes i systemets sikre login-lager. Forbindelsesindstillinger blev gemt, men du skal muligvis indtaste adgangskoden igen næste gang.",
