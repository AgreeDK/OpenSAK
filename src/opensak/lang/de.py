...
STRINGS: dict[str, str] = {
    ...
    "email_intro":                         "Verbinden Sie ein E-Mail-Konto, um Pocket-Query-Zip-Dateien, die Geocaching.com Ihnen zusendet, automatisch abzurufen, statt sie manuell herunterzuladen.",
    "email_group_connection":              "Verbindung",
    "email_server_label":                  "IMAP-Server:",
    "email_port_label":                    "Port:",
    "email_username_label":                "E-Mail-Adresse:",
    "email_password_label":                "Passwort:",
    "email_password_placeholder_saved":    "•••••••• (gespeichert — leer lassen zum Beibehalten)",
    "email_password_placeholder_new":      "Passwort eingeben",
    "email_help_app_password":             "Gmail, iCloud und die meisten anderen Anbieter verlangen hier ein app-spezifisches Passwort, nicht Ihr normales Kontopasswort — prüfen Sie die Sicherheitseinstellungen Ihres Kontos, um eines zu erstellen.",
    "email_help_no_outlook":               "Outlook.com/Live.com wird hier noch nicht unterstützt — Microsoft verlangt für diese Konten eine andere Anmeldemethode (wird separat verfolgt).",
    "email_test_btn":                      "Verbindung testen",
    "email_status_untested":               "Noch nicht getestet",
    "email_status_testing":                "Wird getestet...",
    "email_status_success":                "Verbindung erfolgreich",
    "email_status_auth_error":             "Anmeldung fehlgeschlagen — E-Mail-Adresse und Passwort prüfen",
    "email_status_network_error":          "Server nicht erreichbar — Serveradresse und Port prüfen",
    "email_status_unknown_error":          "Etwas ist schiefgelaufen — Details siehe Logs",
    "email_status_missing_fields":         "Bitte zuerst Server, E-Mail-Adresse und Passwort ausfüllen",
    "email_save_error_title":              "Passwort konnte nicht gespeichert werden",
    "email_save_error_msg":                "Das Passwort konnte nicht im sicheren Anmeldeinformationsspeicher des Systems gespeichert werden. Die Verbindungseinstellungen wurden gespeichert, aber Sie müssen das Passwort beim nächsten Mal möglicherweise erneut eingeben.",
