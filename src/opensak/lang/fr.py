...
STRINGS: dict[str, str] = {
    ...
    "email_intro":                         "Connectez un compte e-mail pour récupérer automatiquement les fichiers zip de Pocket Query envoyés par Geocaching.com, au lieu de les télécharger manuellement.",
    "email_group_connection":              "Connexion",
    "email_server_label":                  "Serveur IMAP :",
    "email_port_label":                    "Port :",
    "email_username_label":                "Adresse e-mail :",
    "email_password_label":                "Mot de passe :",
    "email_password_placeholder_saved":    "•••••••• (enregistré — laisser vide pour conserver)",
    "email_password_placeholder_new":      "Saisir le mot de passe",
    "email_help_app_password":             "Gmail, iCloud et la plupart des autres fournisseurs nécessitent ici un mot de passe spécifique à l'application, pas votre mot de passe habituel — vérifiez les paramètres de sécurité de votre compte pour en générer un.",
    "email_help_no_outlook":               "Outlook.com / Live.com n'est pas encore pris en charge ici — Microsoft exige une méthode de connexion différente pour ces comptes (suivi séparément).",
    "email_test_btn":                      "Tester la connexion",
    "email_status_untested":               "Pas encore testé",
    "email_status_testing":                "Test en cours...",
    "email_status_success":                "Connexion réussie",
    "email_status_auth_error":             "Échec de connexion — vérifiez l'adresse e-mail et le mot de passe",
    "email_status_network_error":          "Impossible de joindre le serveur — vérifiez l'adresse et le port",
    "email_status_unknown_error":          "Une erreur s'est produite — voir les journaux pour plus de détails",
    "email_status_missing_fields":         "Remplissez d'abord le serveur, l'adresse e-mail et le mot de passe",
    "email_save_error_title":              "Impossible d'enregistrer le mot de passe",
    "email_save_error_msg":                "Le mot de passe n'a pas pu être enregistré dans le gestionnaire d'identifiants sécurisé du système. Les paramètres de connexion ont été enregistrés, mais il se peut que vous deviez ressaisir le mot de passe la prochaine fois.",
