...
STRINGS: dict[str, str] = {
    ...
    # ── PQ e-mail (issue #443) ────────────────────────────────────────────────
    "settings_tab_email":                  "PQ Email",
    "email_intro":                         "Connect an e-mail account to automatically fetch Pocket Query zip files that Geocaching.com mails you, instead of downloading them by hand.",
    "email_group_connection":              "Connection",
    "email_server_label":                  "IMAP server:",
    "email_port_label":                    "Port:",
    "email_username_label":                "E-mail address:",
    "email_password_label":                "Password:",
    "email_password_placeholder_saved":    "•••••••• (saved — leave blank to keep)",
    "email_password_placeholder_new":      "Enter password",
    "email_help_app_password":             "Gmail, iCloud and most other providers require an app-specific password here, not your normal account password — check your account's security settings to generate one.",
    "email_help_no_outlook":               "Outlook.com / Live.com is not supported here yet — Microsoft requires a different login method for those accounts (tracked separately).",
    "email_test_btn":                      "Test connection",
    "email_status_untested":               "Not tested yet",
    "email_status_testing":                "Testing...",
    "email_status_success":                "Connection successful",
    "email_status_auth_error":             "Login failed — check e-mail address and password",
    "email_status_network_error":          "Could not reach the server — check server address and port",
    "email_status_unknown_error":          "Something went wrong — see logs for details",
    "email_status_missing_fields":         "Fill in server, e-mail address and password first",
    "email_save_error_title":              "Could not save password",
    "email_save_error_msg":                "The password could not be saved to the system's secure credential store. Connection settings were saved, but you may need to enter the password again next time.",
