...
STRINGS: dict[str, str] = {
    ...
    "email_intro":                         "Připojte e-mailový účet a automaticky stahujte zip soubory Pocket Query, které vám posílá Geocaching.com, místo ručního stahování.",
    "email_group_connection":              "Připojení",
    "email_server_label":                  "Server IMAP:",
    "email_port_label":                    "Port:",
    "email_username_label":                "E-mailová adresa:",
    "email_password_label":                "Heslo:",
    "email_password_placeholder_saved":    "•••••••• (uloženo — ponechte prázdné pro zachování)",
    "email_password_placeholder_new":      "Zadejte heslo",
    "email_help_app_password":             "Gmail, iCloud a většina ostatních poskytovatelů zde vyžadují heslo specifické pro aplikaci, nikoli běžné heslo k účtu — vygenerujte si ho v nastavení zabezpečení účtu.",
    "email_help_no_outlook":               "Outlook.com/Live.com zde zatím není podporován — Microsoft u těchto účtů vyžaduje jiný způsob přihlášení (řešeno samostatně).",
    "email_test_btn":                      "Otestovat připojení",
    "email_status_untested":               "Zatím netestováno",
    "email_status_testing":                "Testuje se...",
    "email_status_success":                "Připojení úspěšné",
    "email_status_auth_error":             "Přihlášení se nezdařilo — zkontrolujte e-mailovou adresu a heslo",
    "email_status_network_error":          "Server nelze kontaktovat — zkontrolujte adresu serveru a port",
    "email_status_unknown_error":          "Něco se pokazilo — podrobnosti najdete v logu",
    "email_status_missing_fields":         "Nejprve vyplňte server, e-mailovou adresu a heslo",
    "email_save_error_title":              "Heslo se nepodařilo uložit",
    "email_save_error_msg":                "Heslo se nepodařilo uložit do bezpečného úložiště přihlašovacích údajů systému. Nastavení připojení bylo uloženo, ale příště možná budete muset heslo zadat znovu.",
