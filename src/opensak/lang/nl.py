...
STRINGS: dict[str, str] = {
    ...
    # ── PQ e-mail (issue #443) ────────────────────────────────────────────────
    "settings_tab_email":                  "PQ e-mail",
    "email_intro":                         "Koppel een e-mailaccount om automatisch Pocket Query zip-bestanden op te halen die Geocaching.com je stuurt, in plaats van ze handmatig te downloaden.",
    "email_group_connection":              "Verbinding",
    "email_server_label":                  "IMAP-server:",
    "email_port_label":                    "Poort:",
    "email_username_label":                "E-mailadres:",
    "email_password_label":                "Wachtwoord:",
    "email_password_placeholder_saved":    "•••••••• (opgeslagen — laat leeg om te behouden)",
    "email_password_placeholder_new":      "Voer wachtwoord in",
    "email_help_app_password":             "Gmail, iCloud en de meeste andere providers vereisen hier een app-specifiek wachtwoord, niet je gewone accountwachtwoord — controleer de beveiligingsinstellingen van je account om er een te genereren.",
    "email_help_no_outlook":               "Outlook.com/Live.com wordt hier nog niet ondersteund — Microsoft vereist een andere inlogmethode voor die accounts (apart bijgehouden).",
    "email_test_btn":                      "Verbinding testen",
    "email_status_untested":               "Nog niet getest",
    "email_status_testing":                "Bezig met testen...",
    "email_status_success":                "Verbinding geslaagd",
    "email_status_auth_error":             "Aanmelden mislukt — controleer e-mailadres en wachtwoord",
    "email_status_network_error":          "Kan server niet bereiken — controleer serveradres en poort",
    "email_status_unknown_error":          "Er is iets misgegaan — zie logs voor details",
    "email_status_missing_fields":         "Vul eerst server, e-mailadres en wachtwoord in",
    "email_save_error_title":              "Kan wachtwoord niet opslaan",
    "email_save_error_msg":                "Het wachtwoord kon niet worden opgeslagen in de beveiligde credentialopslag van het systeem. Verbindingsinstellingen zijn opgeslagen, maar mogelijk moet je het wachtwoord de volgende keer opnieuw invoeren.",
